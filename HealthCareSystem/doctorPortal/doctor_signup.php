<?php
require 'doctorConfig/doctor_error.php';
?>
<html>
                ...
                <div class="col-lg-12 col-xl-11">
                    <div class="card text-black" style="border-radius: 25px;">
                        <div class="card-body p-md-5">
                            <p style='text-align:right'>Are you a <a href='./doctor_index.php'>Doctor</a></p>
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Sign up</p>
                                    <form action="doctorConfig/doctor_signup_logic.php" method="post"
                                        class="mx-1 mx-md-4">
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-user fa-lg me-3 fa-fw mr-2"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" name="username" id="form3Example1c" placeholder="Username" class="form-control"></input>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="password" name="password" placeholder="Password" class="form-control" title="At least 4 character no speacial character only letters and number"></input>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-lock fa-lg me-3 fa-fw mr-2"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="password" name="password-repeat" placeholder="Repeat Password" class="form-control"></input>
                                                <label class="form-label" for="form3Example4c"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                    <img src="../images/doctorIntro.jpg" class="img-fluid" alt="Doctor image">
