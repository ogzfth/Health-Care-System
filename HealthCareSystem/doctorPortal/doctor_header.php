<?php
session_start();
require_once __DIR__ . '/doctorConfig/doctor_error.php';
...
<body>
    ...
    <?php                 
            if(isset($_SESSION['doctorId'])){        
              {require_once __DIR__ . '/doctor_portal.php'; }       
        }
        else {
            ...
            echo '<form action="doctorConfig/doctor_login.php" method="post" style="margin-bottom: 0px;">                
                                    ...
                                    <div class="card bg-dark text-white shadow-lg" style="border-radius: 1rem;">
                                        <div class="card-body p-5 text-center">
                                            ...
                                            <div class="mb-md-5 mt-md-4 pb-5">
                                                ...
                                                <div class="mt-4">
                                                    <p class="mb-0">Don\'t have an account? <a href="doctor_signup.php" class="text-white-50 fw-bold">Sign Up</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
